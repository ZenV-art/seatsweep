  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div aria-hidden className="orb animate-float" style={{ width: 320, height: 320, background: "rgb(251 113 133 / 0.7)", top: -40, left: -80 }} />
        <div aria-hidden className="orb animate-float" style={{ width: 380, height: 380, background: "rgb(254 205 211 / 0.7)", top: 120, right: -120, animationDelay: "1.5s" }} />
        <div className="mx-auto max-w-[1200px] px-6 pt-16 md:pt-24 pb-16">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-5 flex flex-wrap justify-center items-center gap-x-5 gap-y-2 text-xs text-[var(--color-muted-foreground)] animate-in-up" style={{ animationDelay: "200ms" }}>
          ...
          <div className="mt-14 md:mt-20 animate-in-up" style={{ animationDelay: "260ms" }}>
            <HeroPreview />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-24">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-4">
          <Stagger step={110} delay={100} className="contents">
            {[
              ...
              <div key={c.title} className="card-hover rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-white p-6">
      ...
      {/* HOW IT WORKS */}
      <section id="how" className="relative bg-[var(--color-subtle)] border-y border-[var(--color-border)] overflow-hidden">
        <div aria-hidden className="orb" style={{ width: 400, height: 400, background: "rgb(254 205 211 / 0.5)", top: -100, left: "40%" }} />
        <div className="mx-auto max-w-[1200px] px-6 py-24 relative">
          <Reveal>
            <div className="max-w-2xl">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-4">
            <Stagger step={130} delay={80} className="contents">
              {[
                {
                  n: "01",
                ...
                <div key={s.n} className="card-hover relative rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-white p-6">
      ...
      <section id="integrations" className="mx-auto max-w-[1200px] px-6 py-24">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
          <Stagger step={80} delay={60} className="contents">
            {[
              ...
              <div key={k} className="card-hover group rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-white p-5">
      ...
      {/* FEATURES */}
      <section className="relative bg-[var(--color-subtle)] border-y border-[var(--color-border)] overflow-hidden">
        <div aria-hidden className="orb" style={{ width: 500, height: 500, background: "rgb(251 113 133 / 0.3)", bottom: -200, right: -100 }} />
        <div className="mx-auto max-w-[1200px] px-6 py-24 relative">
          <Reveal>
            <div className="max-w-2xl">
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            <Stagger step={90} delay={60} className="contents">
              {[
                ...
                <div key={f.t} className="card-hover rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-white p-6">
                  <div className="h-10 w-10 rounded-[var(--radius-md)] bg-[var(--color-primary-soft)] text-[var(--color-primary-soft-foreground)] flex items-center justify-center">
                    {f.icon}
                  </div>
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-24">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-4">
          <Stagger step={110} delay={80} className="contents">
            {[
              ...
              <div key={i} className="card-hover rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-white p-6 flex flex-col">
      ...
      {/* PRICING */}
      <section id="pricing" className="relative bg-[var(--color-subtle)] border-y border-[var(--color-border)] overflow-hidden">
        <div aria-hidden className="orb" style={{ width: 500, height: 500, background: "rgb(254 202 202 / 0.55)", top: -100, left: "50%", transform: "translateX(-50%)" }} />
        <div className="mx-auto max-w-[1200px] px-6 py-24 relative">
          <Reveal>
            <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            <Stagger step={130} delay={120} className="contents">
              <PricingCard
                name="Starter"
                price="Free"
                sub="Forever"
      ...
      <section className="px-6 pb-24">
        <Reveal>
          <div className="mx-auto max-w-[1100px] relative overflow-hidden rounded-[var(--radius-2xl)] bg-gradient-to-br from-[#fb7185] via-[#ef4444] to-[#b91c1c] p-10 md:p-16 text-white shadow-[0_24px_60px_-20px_rgb(239_68_68/0.45)]">
            ...
            <div aria-hidden className="orb" style={{ width: 300, height: 300, background: "rgb(255 255 255 / 0.25)", top: -100, right: -60 }} />
...
function PricingCard({
  ...
  return (
    <div
      className={`card-hover relative rounded-[var(--radius-xl)] border bg-white p-6 flex flex-col ${
        featured
